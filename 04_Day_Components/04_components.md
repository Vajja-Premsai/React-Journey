...
<sub>Author:
<a href="https://www.linkedin.com/in/asabeneh/" target="_blank">Asabeneh Yetayeh</a><br>V
...
2. What is a React Component?  A React component is a small, reusable code, which is responsible for one part of the application UI.
...
4. What is the difference between a pure JavaScript function and a functional component?
  ```js
  //component is implemented as a pure JavaScript function. It does not have any side effects, so it can be safely called multiple times without affecting the state of the application.The main difference between a pure JavaScript function and a functional component is that a functional component can access and update the state of the application. This means that it is not strictly pure, but it is still considered to be a pure component because it does not have any other side effects.
  In general, functional components are a good choice for simple components that do not need to access or update the state of the application. Pure JavaScript functions are a good choice for more complex functions that need to be reusable and have no side effects.
  ```

5. How small is a React component?
```js
A good rule of thumb is to aim for components that are no more than 100-200 lines of code. This will make your code easier to read, understand, and maintain.
```
6. Can we make a button or input field component?
```js
Yes, you can make a button or input field component in React.
...
//next we can use the button by importing it
...
//next we can make it reuseable by importing it
